...
/**
 * A dash-board is just a Google Sheet with the dash-board template, and dash-board IDs are
 * spreadsheet IDs. The generate end-point is a GET request so that it can be hacked as a link in
 * the Google Sheet.
 */
@Path("/dashboard")
